...
<div class="case-container">
    ...
    <div class="case-intro"
        ...
        <div class="case-intro__text">
            Это — контрольная проверка знаний.
            <br>
            <br> Вас ждут вопросы, на которые Вам предстоит ответить правильно.</div>
        <div class="case-intro__alert">Задание считается пройденным успешно, если Вы справились с ним
            <br>не менее чем на 80 %. У Вас неограниченное количество попыток.</div>
        <div class="case-intro__btn default-btn"
             @click="toggleTest">Приступить</div>
    </div>
    <div class="case-content"
        ...
        <component @check="innerComponentCheck"
                   @next="nextStep"
                   ref="components"
                   :content="currentElem.elem"
                   :magic="magic"
                   :key="step"
                   :is="currentElem.elem.type"></component>
    </div>
            ...
            content: [
                {
                    ...
                    answers: [
                        ...
                        {
                            right: false,
                            text: 'Профессиональные термины'
                        },
                        {
                            right: false,
                            text: 'Эмоциональная составляющая'
                        },
                        {
                            right: false,
                            text: 'Свободная структура'
                        }
                    ]
                },
                {
                    ...
                    answers: [
                        {
                            right: true,
                            text: 'Проблема возникла по вине банка или сотрудника'
                        },
                        {
                            right: false,
                            text: 'Клиент высказывает свое недовольство'
                        },
                        {
                            right: false,
                            text: 'Ответ на обращение поступает с задержкой'
                        },
                        {
                            right: false,
                            text: 'Клиент обращается повторно по одному и тому же вопросу'
                        }
                    ]
                }
            ]
...
.case-intro {
    ...
    &__alert {
        margin-top: 40px;
        font-weight: 100;
        font-style: italic; //color: #33B370;
        margin-bottom: 65px;
    }
    &__btn_start {
        width: 209px;
...
.ex-question-answer::before {
    ...
    content: '';
    width: 32px;
    height: 32px; //border: 2px solid #40a800;
    position: absolute;
    left: -50px;
    top: calc(50%);
...
.exercice__variant:active,
.exercice__variant:hover {
