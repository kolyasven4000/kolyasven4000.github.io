...
export default {
    ...
    data: function() {
        return {
            ...
            testStarted: false,
            content: [{
                text: "Мексика считается единственной страной, где обитает",
                type: 'ex-test',
                style: 'radio',
                answers: [
                    { right: true, text: "Вулканический кролик" },
                    { right: false, text: "Короткохвостая игуана" },
                    { right: false, text: "Пепельный колибри" },
                      ]
                  }, {
