                ...
                <div v-show="interface"
                    ...
                    <div class="buttons">
                        ...
                        <div class="buttons--right">
                            ...
                            <div v-show="quality" @click.prevent.stop="showHideQuality"
...
<script>
	export default {
	    ...
	    methods: {
	        ...
	        seekVideo(e) {
	            var percent = parseInt(e.offsetX / e.target.offsetWidth * 100);
...
.videoplayer {
    ...
    &__controls {
        ...
        .btn-zoom {
            ...
            height: 18px;
            right: 20px;
            background-image: url("/static/img/videoplayer/btn-zoom.svg");
        }
        .btn-sound {
        	transform: translateY(-50%);
            &.mute {
                .btn-volume {
                    background-image: url("/static/img/videoplayer/btn-mute.svg");
                }
                .volume-bar__current {
                    width: 0%;
                }
        ...
        .btn-volume {
            ...
            height: 22px;
            left: -35px;
            background-image: url("/static/img/videoplayer/btn-volume.svg");
        }
        .volume-bar-wrapper {
            width: 65px;
            height: 11px;
        ...
        .btn-play {
            ...
            width: 16px;
            height: 17px;
            background-image: url("/static/img/videoplayer/btn-play.svg");
        }
        .btn-prev,
        .btn-next {
            width: 25px;
        ...
        .btn-prev {
            background-image: url("/static/img/videoplayer/btn-next.svg");
        ...
        .btn-pause {
            ...
            width: 16px;
            height: 18px;
            background-image: url("/static/img/videoplayer/btn-pause.svg");
        }
        .btn {
