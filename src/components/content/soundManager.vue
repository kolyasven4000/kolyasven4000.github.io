<template>
    <div class="sound-manager">
        <audio class="sound-manager__element--content " id="js-audio" :src="content.src" type="audio/mpeg" ref="content"  preload autobuffer></audio>
        <button class="default-btn" @click="playPause">{{btnName}}</button>
...
export default {
  ...
  visualizer() {
    ...
    call = requestAnimationFrame(this.visualizer);
  },
        ...
        ...mapActions([ 'initContentSound', 'playSound', 'pauseSound' ])
    }
}
</script>
